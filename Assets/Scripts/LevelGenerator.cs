...
public class LevelGenerator : MonoBehaviour
{
    ...
    [SerializeField] private int _roomsToBonus;//спавн бонусных комнат пока не реализован
    ...
    private bool _playerHaveSword;//изменение состояния пока не реализовано
